...
if(study.equals("0")){
  ...
  <center>
	...
	<%if(manager.reservationCheck("9", "1", "wednesday").equals("")) { %>
		<td><a href ="reservationPro.jsp?time=9&select=1&day=wednesday">예약해주세요</a></td>
		<%} else{ %>
		<td><%
	...
	<%if(manager.reservationCheck("9", "2" ,"wednesday").equals("")) { %>
		<td><a href ="reservationPro.jsp?time=9&select=2&day=wednesday">예약해주세요</a></td>
		<%} else{ %>
		<td><%
	...
	<%if(manager.reservationCheck("9", "3", "wednesday").equals("")) { %>
		<td><a href ="reservationPro.jsp?time=9&select=3&day=wednesday">예약해주세요</a></td>
		<%} else{ %>
		<td><%
	...
	<%if(manager.reservationCheck("9", "4", "wednesday").equals("")) { %>
		<td><a href ="reservationPro.jsp?time=9&select=4&day=wednesday">예약해주세요</a></td>
		<%} else{ %>
		<td><%
	...
	<%if(manager.reservationCheck("9", "5", "wednesday").equals("")) { %>
		<td><a href ="reservationPro.jsp?time=9&select=5&day=wednesday">예약해주세요</a></td>
		<%} else{ %>
		<td><%
	...
	<%if(manager.reservationCheck("9", "6", "wednesday").equals("")) { %>
		<td><a href ="reservationPro.jsp?time=9&select=6&day=wednesday">예약해주세요</a></td>
		<%} else{ %>
		<td><%
...
<table class="table-style-three" width= "300" > <!-- 10시 -->
	...
	<%if(manager.reservationCheck("10", "1", "wednesday").equals("")) { %>
		<td><a href ="reservationPro.jsp?time=10&select=1&day=wednesday">예약해주세요</a></td>
		<%} else{ %>
		<td><%
	...
	<%if(manager.reservationCheck("10", "2", "wednesday").equals("")) { %>
		<td><a href ="reservationPro.jsp?time=10&select=2&day=wednesday">예약해주세요</a></td>
		<%} else{ %>
		<td><%
	...
	<%if(manager.reservationCheck("10", "3", "wednesday").equals("")) { %>
		<td><a href ="reservationPro.jsp?time=10&select=3&day=wednesday">예약해주세요</a></td>
		<%} else{ %>
		<td><%
	...
	<%if(manager.reservationCheck("10", "4", "wednesday").equals("")) { %>
		<td><a href ="reservationPro.jsp?time=10&select=4&day=wednesday">예약해주세요</a></td>
		<%} else{ %>
		<td><%
	...
	<%if(manager.reservationCheck("10", "5", "wednesday").equals("")) { %>
		<td><a href ="reservationPro.jsp?time=10&select=5&day=wednesday">예약해주세요</a></td>
		<%} else{ %>
		<td><%
	...
	<%if(manager.reservationCheck("10", "6", "wednesday").equals("")) { %>
		<td><a href ="reservationPro.jsp?time=10&select=6&day=wednesday">예약해주세요</a></td>
		<%} else{ %>
		<td><%
	...
	<%if(manager.reservationCheck("11", "1", "wednesday").equals("")) { %>
		<td><a href ="reservationPro.jsp?time=11&select=1&day=wednesday">예약해주세요</a></td>
		<%} else{ %>
		<td><%
	...
	<%if(manager.reservationCheck("11", "2", "wednesday").equals("")) { %>
		<td><a href ="reservationPro.jsp?time=11&select=2&day=wednesday">예약해주세요</a></td>
		<%} else{ %>
		<td><%
	...
	<%if(manager.reservationCheck("11", "3", "wednesday").equals("")) { %>
		<td><a href ="reservationPro.jsp?time=11&select=3&day=wednesday">예약해주세요</a></td>
		<%} else{ %>
		<td><%
	...
	<%if(manager.reservationCheck("11", "4", "wednesday").equals("")) { %>
		<td><a href ="reservationPro.jsp?time=11&select=4&day=wednesday">예약해주세요</a></td>
		<%} else{ %>
		<td><%
	...
	<%if(manager.reservationCheck("11", "5", "wednesday").equals("")) { %>
		<td><a href ="reservationPro.jsp?time=11&select=5&day=wednesday">예약해주세요</a></td>
		<%} else{ %>
		<td><%
	...
	<%if(manager.reservationCheck("11", "6", "wednesday").equals("")) { %>
		<td><a href ="reservationPro.jsp?time=11&select=6&day=wednesday">예약해주세요</a></td>
		<%} else{ %>
		<td><%
...
<table class="table-style-three" width= "300" > <!-- 1시 -->
	...
	<%if(manager.reservationCheck("1", "1", "wednesday").equals("")) { %>
		<td><a href ="reservationPro.jsp?time=1&select=1&day=wednesday">예약해주세요</a></td>
		<%} else{ %>
		<td><%
	...
	<%if(manager.reservationCheck("1", "2", "wednesday").equals("")) { %>
		<td><a href ="reservationPro.jsp?time=1&select=2&day=wednesday">예약해주세요</a></td>
		<%} else{ %>
		<td><%
	...
	<%if(manager.reservationCheck("1", "3", "wednesday").equals("")) { %>
		<td><a href ="reservationPro.jsp?time=1&select=3&day=wednesday">예약해주세요</a></td>
		<%} else{ %>
		<td><%
	...
	<%if(manager.reservationCheck("1", "4", "wednesday").equals("")) { %>
		<td><a href ="reservationPro.jsp?time=1&select=4&day=wednesday">예약해주세요</a></td>
		<%} else{ %>
		<td><%
	...
	<%if(manager.reservationCheck("1", "5", "wednesday").equals("")) { %>
		<td><a href ="reservationPro.jsp?time=1&select=5&day=wednesday">예약해주세요</a></td>
		<%} else{ %>
		<td><%
	...
	<%if(manager.reservationCheck("1", "6", "wednesday").equals("")) { %>
		<td><a href ="reservationPro.jsp?time=1&select=6&day=wednesday">예약해주세요</a></td>
		<%} else{ %>
		<td><%
...
<table class="table-style-three" width= "300" > <!-- 2시 -->
	...
	<%if(manager.reservationCheck("2", "1", "wednesday").equals("")) { %>
		<td><a href ="reservationPro.jsp?time=2&select=1&day=wednesday">예약해주세요</a></td>
		<%} else{ %>
		<td><%
	...
	<%if(manager.reservationCheck("2", "2", "wednesday").equals("")) { %>
		<td><a href ="reservationPro.jsp?time=2&select=2&day=wednesday">예약해주세요</a></td>
		<%} else{ %>
		<td><%
	...
	<%if(manager.reservationCheck("2", "3", "wednesday").equals("")) { %>
		<td><a href ="reservationPro.jsp?time=2&select=3&day=wednesday">예약해주세요</a></td>
		<%} else{ %>
		<td><%
	...
	<%if(manager.reservationCheck("2", "4", "wednesday").equals("")) { %>
		<td><a href ="reservationPro.jsp?time=2&select=4&day=wednesday">예약해주세요</a></td>
		<%} else{ %>
		<td><%
	...
	<%if(manager.reservationCheck("2", "5", "wednesday").equals("")) { %>
		<td><a href ="reservationPro.jsp?time=2&select=5&day=wednesday">예약해주세요</a></td>
		<%} else{ %>
		<td><%
	...
	<%if(manager.reservationCheck("2", "6", "wednesday").equals("")) { %>
		<td><a href ="reservationPro.jsp?time=2&select=6&day=wednesday">예약해주세요</a></td>
		<%} else{ %>
		<td><%
...
<table class="table-style-three" width= "300" > <!-- 3시 -->
	...
	<%if(manager.reservationCheck("3", "1", "wednesday").equals("")) { %>
		<td><a href ="reservationPro.jsp?time=3&select=1&day=wednesday">예약해주세요</a></td>
		<%} else{ %>
		<td><%
	...
	<%if(manager.reservationCheck("3", "2", "wednesday").equals("")) { %>
		<td><a href ="reservationPro.jsp?time=3&select=2&day=wednesday">예약해주세요</a></td>
		<%} else{ %>
		<td><%
	...
	<%if(manager.reservationCheck("3", "3", "wednesday").equals("")) { %>
		<td><a href ="reservationPro.jsp?time=3&select=3&day=wednesday">예약해주세요</a></td>
		<%} else{ %>
		<td><%
	...
	<%if(manager.reservationCheck("3", "4", "wednesday").equals("")) { %>
		<td><a href ="reservationPro.jsp?time=3&select=4&day=wednesday">예약해주세요</a></td>
		<%} else{ %>
		<td><%
	...
	<%if(manager.reservationCheck("3", "5", "wednesday").equals("")) { %>
		<td><a href ="reservationPro.jsp?time=3&select=5&day=wednesday">예약해주세요</a></td>
		<%} else{ %>
		<td><%
	...
	<%if(manager.reservationCheck("3", "6", "wednesday").equals("")) { %>
		<td><a href ="reservationPro.jsp?time=3&select=6&day=wednesday">예약해주세요</a></td>
		<%} else{ %>
		<td><%
...
<table class="table-style-three" width= "300" > <!-- 4시 -->
	...
	<%if(manager.reservationCheck("4", "1", "wednesday").equals("")) { %>
		<td><a href ="reservationPro.jsp?time=4&select=1&day=wednesday">예약해주세요</a></td>
		<%} else{ %>
		<td><%
	...
	<%if(manager.reservationCheck("4", "2", "wednesday").equals("")) { %>
		<td><a href ="reservationPro.jsp?time=4&select=2&day=wednesday">예약해주세요</a></td>
		<%} else{ %>
		<td><%
	...
	<%if(manager.reservationCheck("4", "3", "wednesday").equals("")) { %>
		<td><a href ="reservationPro.jsp?time=4&select=3&day=wednesday">예약해주세요</a></td>
		<%} else{ %>
		<td><%
	...
	<%if(manager.reservationCheck("4", "4", "wednesday").equals("")) { %>
		<td><a href ="reservationPro.jsp?time=4&select=4&day=wednesday">예약해주세요</a></td>
		<%} else{ %>
		<td><%
	...
	<%if(manager.reservationCheck("4", "5", "wednesday").equals("")) { %>
		<td><a href ="reservationPro.jsp?time=4&select=5&day=wednesday">예약해주세요</a></td>
		<%} else{ %>
		<td><%
	...
	<%if(manager.reservationCheck("4", "6", "wednesday").equals("")) { %>
		<td><a href ="reservationPro.jsp?time=4&select=6&day=wednesday">예약해주세요</a></td>
		<%} else{ %>
		<td><%
...
<table class="table-style-three" width= "300" > <!-- 5시 -->
	...
	<%if(manager.reservationCheck("5", "1", "wednesday").equals("")) { %>
		<td><a href ="reservationPro.jsp?time=5&select=1&day=wednesday">예약해주세요</a></td>
		<%} else{ %>
		<td><%
	...
	<%if(manager.reservationCheck("5", "2", "wednesday").equals("")) { %>
		<td><a href ="reservationPro.jsp?time=5&select=2&day=wednesday">예약해주세요</a></td>
		<%} else{ %>
		<td><%
	...
	<%if(manager.reservationCheck("5", "3", "wednesday").equals("")) { %>
		<td><a href ="reservationPro.jsp?time=5&select=3&day=wednesday">예약해주세요</a></td>
		<%} else{ %>
		<td><%
	...
	<%if(manager.reservationCheck("5", "4", "wednesday").equals("")) { %>
		<td><a href ="reservationPro.jsp?time=5&select=4&day=wednesday">예약해주세요</a></td>
		<%} else{ %>
		<td><%
	...
	<%if(manager.reservationCheck("5", "5", "wednesday").equals("")) { %>
		<td><a href ="reservationPro.jsp?time=5&select=5&day=wednesday">예약해주세요</a></td>
		<%} else{ %>
		<td><%
	...
	<%if(manager.reservationCheck("5", "6", "wednesday").equals("")) { %>
		<td><a href ="reservationPro.jsp?time=5&select=6&day=wednesday">예약해주세요</a></td>
		<%} else{ %>
		<td><%
